    ...
    $.fn.automtn = function (options) {
        ...
        if (action == 'init') {
            ...
            var gen = function (name, _default) {
                ...
                if ((typeof value === 'undefined' || value === null) && typeof _default !== 'undefined') {
                    if (_default === null) {
                        e.data(name, _default);
                    }
                    else {
            ...
            var key = gen("key", null);
            var value = gen("value", null);
            var parseChild = gen("parsechild", "auto");
			var parseMode = gen("parsemode", "none");
...
var Automtn = {
	...
	each: function (e, data, fn) {
	    ...
	    var parsemode = e.data("parsemode");
    ...
    fill: function (e, data, method, mode) {
        ...
        var parseChild = e.data("parsechild").toLowerCase();
