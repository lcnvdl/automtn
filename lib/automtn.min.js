...
h=a.data("fetch"),f=String(a.data("external"))=="true",j=a.data("beforefill"),k=a.data("loadstart"),l=a.data("loadfinish"),m=a.data("loaderror"),n=a.data("loadsuccess"),o=a.data("method"),d={};e&&e.abort();try{a.trigger("onloadstart",[a]);Automtn.call(this,k,a)}catch(p){}d={type:o,url:h,data:d,context:a,success:function(a){var c={ajax:this,success:typeof a.success==="undefined"?true:a.success,result:a};if(!c.success&&typeof a.error!=="undefined")c.error=a.error;try{this.trigger("beforefill",c);Automtn.call(this,
j,c);this.automtn({action:"fill",data:a});this.trigger("onloadsuccess",c);Automtn.call(this,n,c)}catch(d){a=b.extend(c,{success:false,error:d});this.trigger("onloaderror",a);Automtn.call(this,m,a)}finally{Automtn.call(this,l,c);this.trigger("onloadfinish",c)}},error:function(a,b,c){a={success:false,error:a&&a.responseJSON&&a.responseJSON.error?a.responseJSON.error:c};this.trigger("onloaderror",a);this.trigger("onloadfinish",a);Automtn.call(this,m,a);Automtn.call(this,l)},async:true};if(f)d.dataType=
"jsonp";else{d.dataType="json";d.contentType="application/json; charset=utf-8"}e=b.ajax(d);a.data("request",e)}return a};b(document).ready(function(){b("[data-fetch]").each(function(){b(this).automtn({action:"init"})})})})(jQuery||$);
var Automtn={id:1,defaults:{action:"init",fetch:"",fill:"self",filltype:"",events:"document-ready",method:"POST",mode:"overwrite",external:!1,onlyvalue:!1,parsechild:"auto",parsemode:"none",tpl:"{value}",key:null,value:null,beforefill:null,loadstart:null,loadfinish:null,loaderror:null,loadsuccess:null,subscript:null},mode:{Overwrite:"overwrite",Append:"append"},parsers:{None:"none",KvAsValues:"kv-as-values",KvAsArray:"kv-as-array",ArrayAsKv:"array-as-kv"},get:function(b,c,a){return typeof a=="undefined"?
b.data(c):b.data(c,a)},toDict:function(b,c,a){for(var d={},f=0;f<b.length;f++){var g=b[f];typeof g==="object"?d[c?g[c]:f]=a?g[a]:g:d[f]=g}return d},each:function(b,c,a){var d=Automtn.get(b,"key"),f=Automtn.get(b,"value"),g=Automtn.get(b,"parsemode"),e;if(String(Automtn.get(b,"onlyvalue")).toLowerCase()=="false"){$.isArray(c)&&(c=Automtn.toDict(c,d,f));e=c}else if($.isArray(c))e=Automtn.toDict(c,d,f);else{e={};$.each(c,function(a,b){if(typeof b==="string"||typeof b==="number")e[a]=b})}if(g=="kv-as-values"){var h=
0,i={};$.each(e,function(a,b){i[h++]=a;i[h++]=b});e=i}else if(g=="kv-as-array"){h=0;i={};$.each(e,function(a,b){i[h++]=[a,b]});e=i}else if(g=="array-as-kv"){h=0;i={};$.each(e,function(a,b){i[b[0]]=b[1]});e=i}$.each(e,a)},fill:function(b,c,a,d){var d=d||Automtn.mode.Overwrite,c=typeof c=="string"?{"?":c}:c,f=Automtn.get(b,"parsechild").toLowerCase();if(f=="auto"&&c.length==1||f=="yes")c=c[c.getKey()];(Automtn._fill[a]||Automtn._fill.div)(b,c,d)},call:function(b,c,a){if(typeof c==="string"){if(c=="")return null;
c=c.indexOf("function")===0?eval(c):typeof a==="undefined"?new Function(c):new Function("args",c)}else if(typeof c!=="function")return null;return c?c.call(b,a):null},_val:function(b,c,a,d){return(d||Automtn.get(b,"tpl")).replaceAll("{key}",c).replaceAll("{value}",a)},_fill:{ol:function(b,c,a){return Automtn._fill.ul(b,c,a)},ul:function(b,c,a){a==Automtn.mode.Overwrite&&b.html("");var d=Automtn.get(b,"tpl");if(d=="{value}"){d="<li>{value}</li>";Automtn.get(b,"tpl",d)}Automtn.each(b,c,function(a,c){var e=
Automtn._val(b,a,c,d);b.appendStr(e)})},select:function(b,c,a){a==Automtn.mode.Overwrite&&b.html("");var d=Automtn.get(b,"tpl");if(d=="{value}"){d="<option value='{key}'>{value}</li>";Automtn.get(b,"tpl",d)}Automtn.each(b,c,function(a,c){var e=Automtn._val(b,a,c,d);b.appendStr(e)})},table:function(b,c,a){var d=b.children("tbody"),f=d.length>0?d:b;a==Automtn.mode.Overwrite&&f.html("");a=Automtn.get(b,"tpl");a=="{value}"&&Automtn.get(b,"tpl","<td>{value}</td>");var g=Automtn.get(b,"tpl-tr");if(typeof g===
"undefined"){g="<tr data-key='{key}'>{value}</td>";Automtn.get(b,"tpl-tr",g)}Automtn.each(b,c,function(a,c){var d=$("<tr>"),j;j=$.isArray(c)?c:[c];(String(Automtn.get(b,"showkey"))=="1"||String(Automtn.get(b,"showkey"))=="true")&&$("<td>").attr("data-key",a).html(a).appendTo(d);for(var k=0;k<j.length;k++){var l=Automtn._val(b,a,j[k]);d.appendStr(l)}$(Automtn._val(b,a,d.html(),g)).appendTo(f);d.remove()})},div:function(b,c,a){typeof c=="string"&&(c={"?":c});a==Automtn.mode.Overwrite&&b.html("");Automtn.each(b,
c,function(a,c){var g=Automtn._val(b,a,c);b.appendStr(g)})}}};
